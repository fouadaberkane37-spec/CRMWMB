  ...
  return (
    <div className="px-4 pt-6 pb-4 md:p-8 overflow-x-auto min-w-0">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-slate-100">Companies</h1>
      ...
      <div className="bg-slate-900 rounded-xl border border-slate-700/50 overflow-x-auto">
